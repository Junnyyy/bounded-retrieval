...
- Anthropic recommends returning high-signal data with stable identifiers and using dedicated tools when actions need distinct gating, rendering, or auditing. See [Tool definition best practices](https://platform.claude.com/docs/en/agents-and-tools/tool-use/define-tools#best-practices-for-tool-definitions).
